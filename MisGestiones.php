...
?>
	<h1 class="text-center fs-1 fw-bolder"><img src="imagenes/L D Q.png" width="125px" height="125px"class="border border-secondary border-1 rounded-circle">Gestiones de <?php echo"$A"; ?> <img src="imagenes/L D Q.png" width="125px" height="125px"class="border border-secondary border-1 rounded-circle"></h1><br><br><br><center>
		...
		<td align="center" valign="center" ><Form Action="SeguimientosPorArea.php" Method="Post">
		    <button type="submit" class="botoncito1"><box-icon class="border border-secondary border-3 rounded-circle" name="list-ol" type="solid" size="lg" color="#FAE5D3" animation="tada"></box-icon> <?Php if ($Tipo=='A'){
							echo'Seguimientos' ;
							} else{
								   echo'Mis Seguimientos'; }?></button></form></td>
		<td align="center" valign="center" ><Form Action="ReclamosPorArea.php" Method="Post">
		     <button type="submit" class="botoncito1"><box-icon class="border border-secondary border-3 rounded-circle" name="library" type="solid" size="lg" color="#FAE5D3" animation="tada-hover"></box-icon><?Php if ($Tipo=='A'){
							echo'Reclamos' ;
							} else{
		...
		<td align="center" valign="center" ><Form Action="CierreReclamo.php" Method="Post">
			 <button type="submit" class="botoncito1"><box-icon class="border border-secondary border-3 rounded-circle" name="window-close" type="solid" size="lg" color="#FAE5D3" animation="tada-hover"></box-icon> Cierre de gestiones </button></form></td>
			<?Php if ($Tipo=='A'){?><td align="center" valign="center" ><Form Action="AltaUsuario.php" Method="Post">
			<button type="submit" class="botoncito1"><box-icon class="border border-secondary border-3 rounded-circle" name="user-plus" type="solid" size="lg" color="#FAE5D3" animation="tada-hover"></box-icon> Alta usuarios </button></form></td><?php }?>
		</tr>
        </table>
