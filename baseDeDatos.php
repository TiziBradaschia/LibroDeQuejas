...
function ConsultaVistaSeguimientoC($Codigo){
 ...
 function ConsultaVistaClienteN($Nombre){
	 $SqlCliente="select* from cliente where Nombre_Cliente='$Nombre'";
	 $Cliente=mysqli_query(conectar(),$SqlCliente) or die ("Error en el select SqlCliente");
	 return $Cliente;
 }
   function ConsultaVistaClienteM($Mail){
	 $SqlCliente="select* from cliente where Mail_Cliente='$Mail'";
	 $Cliente=mysqli_query(conectar(),$SqlCliente) or die ("Error en el select SqlCliente");
	 return $Cliente;
 }
  function ConsultaVistaClienteD($Dni){
	 $SqlCliente="select* from cliente where Dni_Cliente='$Dni'";
	 $Cliente=mysqli_query(conectar(),$SqlCliente) or die ("Error en el select SqlCliente");
	 return $Cliente;
 }
  function ConsultaVistaClienteND($Nombre,$Dni){
	 $SqlCliente="select* from cliente where Dni_Cliente='$Dni' And Nombre_Cliente='$Nombre'";
	 $Cliente=mysqli_query(conectar(),$SqlCliente) or die ("Error en el select SqlCliente");
	 return $Cliente;
 }
  function ConsultaVistaClienteNM($Nombre,$Mail){
	 $SqlCliente="select* from cliente where Nombre_Cliente='$Nombre' And Mail_Cliente='$Mail'";
	 $Cliente=mysqli_query(conectar(),$SqlCliente) or die ("Error en el select SqlCliente");
	 return $Cliente;
 }
  function ConsultaVistaClienteDM($Dni,$Mail){
	 $SqlCliente="select* from cliente where Dni_Cliente='$Dni' And Mail_Cliente='$Mail'";
	 $Cliente=mysqli_query(conectar(),$SqlCliente) or die ("Error en el select SqlCliente");
	 return $Cliente;
 }
 function ConsultaVistaClienteNDM($Nombre,$Dni,$Mail){
	 $SqlCliente="select* from cliente where Dni_Cliente='$Dni' And Nombre_Cliente='$Nombre' And Mail_Cliente='$Mail'";
	 $Cliente=mysqli_query(conectar(),$SqlCliente) or die ("Error en el select SqlCliente");
	 return $Cliente;
 }
  function ConsultaVistaEmpleadoN($Nombre){
 $SqlEmpleado="select* from empleado where Nombre_Personal='$Nombre'";
 $Empleado=mysqli_query(conectar(),$SqlEmpleado) or die ("Error en el select SqlEmpleado");
 return $Empleado;
 }
  function ConsultaVistaEmpleadoM($Mail){
 $SqlEmpleado="select* from empleado where Mail_Personal='$Mail'";
 $Empleado=mysqli_query(conectar(),$SqlEmpleado) or die ("Error en el select SqlEmpleado");
 return $Empleado;
 }
   function ConsultaVistaEmpleadoD($Dni){
 $SqlEmpleado="select* from empleado where Dni_Personal='$Dni'";
 $Empleado=mysqli_query(conectar(),$SqlEmpleado) or die ("Error en el select SqlEmpleado");
 return $Empleado;
 }
  function ConsultaVistaEmpleadoND($Nombre,$Dni){
 $SqlEmpleado="select* from empleado where Dni_Personal='$Dni' And Nombre_Personal='$Nombre'";
 $Empleado=mysqli_query(conectar(),$SqlEmpleado) or die ("Error en el select SqlEmpleado");
 return $Empleado;
 }
  function ConsultaVistaEmpleadoNM($Nombre,$Mail){
 $SqlEmpleado="select* from empleado where Nombre_Personal='$Nombre' And Mail_Personal='$Mail'";
 $Empleado=mysqli_query(conectar(),$SqlEmpleado) or die ("Error en el select SqlEmpleado");
 return $Empleado;
 }
 function ConsultaVistaEmpleadoDM($Dni,$Mail){
 $SqlEmpleado="select* from empleado where Dni_Personal='$Dni'And Mail_Personal='$Mail'";
 $Empleado=mysqli_query(conectar(),$SqlEmpleado) or die ("Error en el select SqlEmpleado");
 return $Empleado;
 }
 function ConsultaVistaEmpleadoNDM($Nombre,$Dni,$Mail){
 $SqlEmpleado="select* from empleado where Dni_Personal='$Dni' And Nombre_Personal='$Nombre' And Mail_Personal='$Mail'";
 $Empleado=mysqli_query(conectar(),$SqlEmpleado) or die ("Error en el select SqlEmpleado");
 return $Empleado;
 }
...
function consultaJerarquia(){
	$consultaJerarquia="Select * from jerarquia";
	$CJer=mysqli_query(conectar(),$consultaJerarquia)or die ("Error base Jerarquia");
	return $CJer;
	
}
function consultaCategoria(){
	$consultaCategoria="Select * from categoriacliente";
	$CCat=mysqli_query(conectar(),$consultaCategoria)or die ("Error base Categoria");
	return $CCat;
...
function InsertCliente($Dni,$Nom,$Mail,$Tel,$Dir,$Barr,$Cat){
$Sql="Insert into clienteexterno (Dni_Cliente,Nombre_Cliente,Mail_Cliente,Tel_Cliente,Dir_Cliente,Barrio_Cliente,Categoria_Cliente)values('$Dni','$Nom','$Mail','$Tel','$Dir','$Barr','$Cat')";
$registro=mysqli_query(conectar(),$Sql)or die("Error en insert clienteexterno");
return $registro;
}
function InsertPersonalReclamo($Dni,$Nom,$Mail,$Area,$Jer){
$Sql="Insert into personalreclamo (Dni_Personal,Nombre_Personal,Mail_Personal,Area,Jerarquia)values('$Dni','$Nom','$Mail','$Area','$Jer')";
$registro=mysqli_query(conectar(),$Sql)or die("Error en insert personalreclamo");
return $registro;
}
