...
if(!isset($_SESSION['Nombre']))
   {
	...
	die ("<Br><Br><Center><Font Color='#EF280F'><H1>&iexcl Usted debe logearse para entrar al sitio !");
	 ...
	 $Tipo=$_SESSION['Tipo'];
?>
<h1 class="text-center fs-1 fw-bolder"><img src="imagenes/L D Q.png" width="125px" height="125px"class="border border-secondary border-1 rounded-circle">Men&uacute de consulta <?Php if ($Tipo=='A'){echo' Administrador ';}else{ echo" Empleados";}?><img src="imagenes/L D Q.png" width="125px" height="125px"class="border border-secondary border-1 rounded-circle"></h1>
	...
	<tr>
		...
		<td>	
			<Form action="ConsultaUsuarios.php" Method="Post">
			 <button type="submit" class="botoncito1"><box-icon class="border border-secondary border-3 rounded-circle" name="face" type="solid" size="lg" color="#FAE5D3" animation="tada"></box-icon> <?Php if ($Tipo=='A'){echo' Usuarios ';}else{ echo" Clientes";}?></button></form>
			</Form>
		</td>
	</tr>
	<tr>
